  ...
  <div class="login-container p20">
    <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-message"></i> 新增房屋信息</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    <div class="container">
      <div class="login-container-main">
          <el-form
            ...
            class="demo-ruleForm"
          >
            <el-form-item label="房屋面积" prop="stuName" style="width: 50%">
              <el-input v-model="ruleForm.stuName"></el-input>
            </el-form-item>
            <el-form-item label="房屋地址" prop="stuName" style="width: 50%">
              <el-input type="textarea" :rows="3" v-model="ruleForm.stuName"></el-input>
            </el-form-item>
            <el-form-item label="房屋归属者" prop="stuName" style="width: 50%">
              <el-input type="textarea" :rows="3" v-model="ruleForm.stuName"></el-input>
            </el-form-item>
            <el-form-item label="客户手机号" prop="stuPhone" style="width: 50%">
              <el-input v-model="ruleForm.stuPhone"></el-input>
            </el-form-item>
            <el-form-item label="房屋类型" prop="stuSex" style="width: 50%">
              <el-radio-group v-model="ruleForm.stuSex">
                <el-radio label="新房"></el-radio>
                <el-radio label="二手房"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="房屋户型" prop="stuSex" style="width: 50%">
              <el-input v-model="ruleForm.stuSex"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-dialog
      ...
      <!-- <span slot="footer" class="dialog-footer">
        <el-button class="pan-btn light-ccc-btn" @click="dialogVisible = false">取消</el-button>
