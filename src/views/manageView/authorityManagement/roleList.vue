  ...
  <div class="p20">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-message"></i> 角色列表
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <table-with-page
        ...
        :pageSize="pageSize"
      >
        <el-button type="primary" size="small" slot="toolbar" @click="to('/authorityManagement/roleAdd')">新增</el-button>
      </table-with-page>
    </div>
    <el-dialog
      title="权限分配"
            ...
            return h('div', [h('el-button', {
              ...
              on: {
                click: () => {
                  ...
                  this.to('/authorityManagement/roleAdd')
                }
              }
            }, '修改'), h('el-button', {
              attrs: {
