    ...
    <div class="login-container-main">
      <el-form
        ...
        >
          ...
          <el-form-item label="手机号" prop="stuPhone" style="width: 50%">
            <el-input v-model="ruleForm.stuPhone"></el-input>
          </el-form-item>
          <el-form-item label="性别" prop="stuSex" style="width: 50%">
            <el-radio-group v-model="ruleForm.stuSex">
              <el-radio label="男"></el-radio>
              <el-radio label="女"></el-radio>
            </el-radio-group>
            </el-form-item>
            <el-form-item label="密码" prop="stuPassword" style="width: 50%">
            ...
            <el-form-item label="身份证号" prop="employeeIdNum" style="width: 50%">
